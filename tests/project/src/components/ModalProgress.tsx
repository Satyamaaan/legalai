...
const stageColors = {
  ...
  'translating': 'text-purple-600 dark:text-purple-400',
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={cn(
                  ...
                  error ? 'bg-red-100 dark:bg-red-950/20' : 'bg-primary/10'
                )}>
                  {error ? (
              ...
              <div className="space-y-2 pt-2 border-t">
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div className={cn(
                    ...
                    displayProgress >= 15 ? 'bg-blue-50 dark:bg-blue-950/20 text-blue-700 dark:text-blue-300' : 'text-muted-foreground'
                  )}>
                  ...
                  <div className={cn(
                    'flex items-center gap-1.5 p-2 rounded transition-colors',
                    displayProgress >= 40 ? 'bg-purple-50 dark:bg-purple-950/20 text-purple-700 dark:text-purple-300' : 'text-muted-foreground'
                  )}>
                  ...
                  <div className={cn(
                    'flex items-center gap-1.5 p-2 rounded transition-colors',
                    displayProgress >= 70 ? 'bg-green-50 dark:bg-green-950/20 text-green-700 dark:text-green-300' : 'text-muted-foreground'
                  )}>
